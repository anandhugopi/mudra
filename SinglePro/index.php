          ...
          <div class="contact_content">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5">
              <div class="contact_form">
                ...
                <form>
                  <input class="form-control" type="text" placeholder="Name" id="cname">
                  <input class="form-control" type="email" placeholder="Email" id="cemail">
                  <input class="form-control" type="text" placeholder="Subject" id="csubject">
                  <textarea class="form-control" cols="30" rows="10" placeholder="Your Message" id="cmessage"></textarea>
                  <input class="submit_btn" type="submit" value="Send" id="csend">  
                </form>
              </div>
            </div>
            <!-- BEGAIN CONTACT MAP -->
